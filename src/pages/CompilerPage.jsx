...
const compilers = [
    { name: 'Java', icon: '☕', id: 'java', language: 'java', judge0_id: 62 },
    { name: 'C++', icon: '💻', id: 'cpp', language: 'cpp', judge0_id: 54 },
    { name: 'Python', icon: '🐍', id: 'python', language: 'python', judge0_id: 71 },
    { name: 'JavaScript', icon: '🟨', id: 'javascript', language: 'javascript', judge0_id: 63 },
    { name: 'C', icon: '📘', id: 'c', language: 'c', judge0_id: 50 },
];
...
const CompilerPage = () => {
    ...
    return (
        <>
            <Navbar />
            <div className="h-[calc(100vh-4rem)] flex bg-[#1c1c1e] text-white overflow-hidden rounded-2xl mt-3 mx-5">
                {/* Sidebar */}
                <div className="w-16 bg-[#1c1c1e] flex flex-col items-center py-4 space-y-4">
                    {compilers.map((c) => (
                        <button
                            ...
                            className={`p-2 rounded hover:bg-blue-600 ${selectedCompiler === c.id ? 'bg-blue-700' : ''}`}
                        >
                            {c.icon}
                        </button>
                    ))}
                ...
                <div className="flex-1 flex flex-col md:flex-row p-4 gap-4 overflow-hidden">
                    ...
                    <div className="w-full md:w-1/2 flex flex-col gap-4">
                        ...
                        <div className="flex-1 bg-black p-4 rounded-lg flex flex-col">
                            ...
                            <div className="flex-1 bg-[#1c1c1e] text-green-400 p-2 rounded overflow-y-auto text-sm whitespace-pre-wrap">
